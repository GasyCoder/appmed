<div class="py-6">
    <div class="mx-auto w-full max-w-[88rem] px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div wire:loading wire:target="search,niveau_filter,perPage,page,editStudent,confirmDelete,deleteUser,createStudent,toggleUserStatus" aria-busy="true" class="space-y-4">
            <x-skeleton.card :lines="2" />
            <x-skeleton.table :columns="4" :rows="6" />
        </div>

        <div wire:loading.remove wire:target="search,niveau_filter,perPage,page,editStudent,confirmDelete,deleteUser,createStudent,toggleUserStatus">
            {{-- Table card --}}
