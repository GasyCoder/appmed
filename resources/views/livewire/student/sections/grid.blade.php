...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    @forelse($documents as $document)
        <div class="group relative bg-white rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300">
            <!-- Type de document et date -->
            <div class="absolute top-4 right-4 flex items-center gap-2">
                <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-white shadow-sm border border-gray-100 text-gray-600">
    ...
    @empty
        <div class="col-span-full">
            <div class="flex flex-col items-center justify-center px-6 py-12 bg-white rounded-xl border border-gray-100">
