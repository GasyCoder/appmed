...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-8">
    ...
    <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-blue-50/50 dark:from-blue-900/20 to-indigo-50/50 dark:to-indigo-900/20">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h2 class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 dark:from-blue-400 to-indigo-600 dark:to-indigo-400">
                        Documents
                    </h2>
            ...
            <!-- Right side - Date -->
            <div class="flex items-center gap-3 text-sm px-4 py-2 bg-white dark:bg-gray-700 rounded-xl shadow-sm border border-gray-100 dark:border-gray-600">
    ...
    <div class="p-6">
        <div class="p-4 flex flex-wrap gap-4 items-center">
            ...
            <select
                ...
                class="py-2.5 pl-10 pr-4 bg-gray-50 dark:bg-gray-700 border-0 rounded-lg text-sm text-gray-900 dark:text-white appearance-none min-w-[200px]"
            >
            ...
            <select
                ...
                class="py-2.5 pl-10 pr-4 bg-gray-50 dark:bg-gray-700 border-0 rounded-lg text-sm text-gray-900 dark:text-white appearance-none min-w-[180px]"
            >
            ...
            <div class="bg-gray-100 dark:bg-gray-700 rounded-lg p-1 flex gap-1">
                <button
                    ...
                    class="p-2 rounded {{ $viewType === 'grid' ? 'bg-white dark:bg-gray-600 shadow text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400' }}"
                >
                ...
                <button
                    ...
                    class="p-2 rounded {{ $viewType === 'list' ? 'bg-white dark:bg-gray-600 shadow text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400' }}"
                >
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
