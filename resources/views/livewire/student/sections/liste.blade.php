...
<div class="space-y-4">
    @forelse($documents as $document)
        <div class="group bg-white rounded-xl overflow-hidden hover:shadow-lg transition-all duration-200">
            <div class="p-5">
                <div class="flex items-center gap-5">
                    ...
                    <div class="flex-shrink-0">
                        <div class="p-3 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                            ...
                            <span class="block text-xs font-medium text-center mt-1 text-gray-500">
    ...
    @empty
        <div class="flex flex-col items-center justify-center py-12 bg-white rounded-xl border border-gray-100">
