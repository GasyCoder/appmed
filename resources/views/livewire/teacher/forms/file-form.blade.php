{{-- livewire.teacher.forms.file-form --}}
<form wire:submit="uploadDocument">
                ...
                <div class="relative">
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <div class="flex items-center justify-between bg-green-50 px-3 py-2 rounded-md">
                            ...
                            <span class="font-bold text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">
                    ...
                    @elseif($niveau_id)
                        <div class="mt-2 flex items-center bg-yellow-50 px-3 py-2 rounded-md">
                            <svg class="w-5 h-5 text-yellow-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                            </svg>
                            <span class="text-sm text-yellow-700">Aucun semestre actif pour ce niveau</span>
                        </div>
                    @endif
    ...
    <div class="mt-6 flex justify-end border-t pt-6">
        <button type="submit"
                class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition"
