{{-- resources/views/pdf/viewer-embedded.blade.php --}}
<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div class="max-w-7xl mx-auto px-4 py-3">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <span id="zoomLevel" class="px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md">100%</span>
        ...
        <div class="flex-1" id="pdfContainer">
            ...
            <div id="pdfViewer" class="hidden">
                ...
                <div class="fixed bottom-14 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 rounded-full shadow-lg border border-gray-200 dark:border-gray-700 px-4 py-2">
                    <div class="flex items-center gap-3">
                        <button id="prevBtn" onclick="previousPage()" disabled
                            class="p-2 text-gray-300 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 disabled:cursor-not-allowed">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                            </svg>
                        </button>
    ...
    <script>
        ...
        async function loadPDF() {
            try {
                // Utiliser la route de service sécurisée
                const fileUrl = '{{ route("pdf.serve", ["filename" => urlencode($filename)]) }}';
