            ...
            <div class="mb-4">
                ...
                <nav class="mt-3 space-y-1">
                        ...
                        <a href="{{ route('timetable') }}"
                            class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors
                            {{ request()->routeIs('timetable') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/75' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                            wire:navigate>
                            <svg class="flex-shrink-0 w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                            </svg>
                        ...
                        <a href="{{ route('scolarites') }}"
                           class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('scolarites') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/75' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}"
                           wire:navigate>
                            <svg class="flex-shrink-0 w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <nav class="mt-3 space-y-1">
                        ...
                        {{-- <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open"
                                 ...
                                 x-transition:leave-end="transform opacity-0 scale-95"
                                 class="pl-12 mt-1 space-y-1">
                                <a href="#" class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-50">
                                    Premier semestre
                                </a>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-50">
                                    Deuxième semestre
