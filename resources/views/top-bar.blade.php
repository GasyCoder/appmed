<!-- Top bar -->
<div class="sticky top-0 flex items-center justify-between h-16 bg-white dark:bg-gray-800 border-b dark:border-gray-700 px-4">
    ...
    >
        ...
        <svg x-show="darkMode" style="z-index: 55" class="w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
